...
module.exports = {
  ...
  autoCancel: { sellerMinutes: Number(process.env.AUTO_CANCEL_SELLER_MINUTES || 30), riderMinutes: Number(process.env.AUTO_CANCEL_RIDER_MINUTES || 30), inProcess: process.env.ENABLE_IN_PROCESS_AUTOCANCEL === 'true' },
