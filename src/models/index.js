...
const Offer = models.Offer || model('Offer', new Schema({title:String,code:{type:String,unique:true,sparse:true},description:String,type:String,value:Number,minOrder:Number,maxDiscount:Number,startAt:Date,endAt:Date,active:{type:Boolean,default:true},outletIds:[objectId('Outlet')],productIds:[objectId('Product')]},{timestamps:true}));
...
module.exports={User,Outlet,Category,Brand,Product,OutletProduct,Cart,Order,OrderEvent,InventoryMovement,Payment,Refund,RiderLocation,RiderEarning,OfflineSale,Invoice,Setting,SettingAudit,Notification,Banner,Offer,Coupon,Review,WalletTransaction,SupportTicket,VerificationRequest,DailyClosing};
